...
metadata:
  ...
  version: "1.0.0"
  description: "Replicate's official hosted MCP server. Connect with your Replicate account to run and manage models."
  tags: ["ai", "models", "inference", "machine-learning"]
  category: "ai"
  author: "replicate"
  license: "Proprietary"
...
Replicate's official hosted MCP server. Connect with your Replicate account to run and manage models.

## How authentication works

1. Click **Connect account** on the Replicate card.
2. A Replicate sign-in window opens. Approve access for the workspace.
...
- Tools are served by the vendor and discovered at session start (models, predictions, and deployments).
