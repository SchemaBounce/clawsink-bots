...
metadata:
  ...
  version: "1.0.0"
  description: "Cloudflare's official AI Gateway MCP server. Inspect AI Gateway logs and configuration with your Cloudflare account."
...
Cloudflare's official AI Gateway MCP server. Inspect AI Gateway logs and configuration with your Cloudflare account.

## How authentication works

1. Click **Connect account** on the Cloudflare AI Gateway card.
2. A Cloudflare AI Gateway sign-in window opens. Approve access for the workspace.
...
- Tools are served by the vendor and discovered at session start (AI Gateway logs and settings).
