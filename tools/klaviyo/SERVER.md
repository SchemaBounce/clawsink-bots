...
metadata:
  ...
  displayName: "Klaviyo"
  version: "1.0.0"
  description: "Klaviyo's official hosted MCP server. Connect with your Klaviyo account to work with campaigns and profiles."
  tags: ["marketing", "email", "sms", "ecommerce"]
  category: "marketing"
  author: "klaviyo"
  license: "Proprietary"
...
Klaviyo's official hosted MCP server. Connect with your Klaviyo account to work with campaigns and profiles.

## How authentication works

1. Click **Connect account** on the Klaviyo card.
2. A Klaviyo sign-in window opens. Approve access for the workspace.
...
- Tools are served by the vendor and discovered at session start (campaigns, flows, profiles, and metrics).
