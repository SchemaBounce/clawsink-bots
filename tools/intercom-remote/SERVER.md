...
kind: McpServer
metadata:
  name: intercom-remote
  displayName: "Intercom (Official)"
  version: "1.0.0"
  description: "Intercom's official hosted MCP server. Connect with your Intercom account to let agents read conversations and contacts."
...
# Intercom (Official) MCP Server

Intercom's official hosted MCP server. Connect with your Intercom account to let agents read conversations and contacts.

## How authentication works

1. Click **Connect account** on the Intercom (Official) card.
2. A Intercom (Official) sign-in window opens. Approve access for the workspace.
...
- Separate from the API-token tools/intercom entry.
