...
auth:
  ...
  setupReason: "Authorized via Composio's managed-OAuth gateway. The agent reaches this service through composio.execute_composio_tool with action names like XERO_*."
transport:
  type: "stdio"
  command: "npx"
