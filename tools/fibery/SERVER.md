...
metadata:
  ...
  displayName: "Fibery"
  version: "1.0.0"
  description: "Fibery's official hosted MCP server. Connect with your Fibery account to work with entities and databases."
  tags: ["work-management", "product", "project-management", "docs"]
...
Fibery's official hosted MCP server. Connect with your Fibery account to work with entities and databases.

## How authentication works

1. Click **Connect account** on the Fibery card.
2. A Fibery sign-in window opens. Approve access for the workspace.
...
- Tools are served by the vendor and discovered at session start (entities, databases, and documents).
