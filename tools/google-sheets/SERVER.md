...
auth:
  ...
  setupReason: "Authorized via Composio's managed-OAuth gateway. The agent reaches this service through composio.execute_composio_tool with action names like GOOGLESHEETS_*."
transport:
  type: "stdio"
  command: "npx"
  args: ["-y", "google-sheets-mcp@1.2.0"]
env:
