...
metadata:
  ...
  version: "1.0.0"
  description: "Cloudflare's official Logpush MCP server. Inspect Logpush job data with your Cloudflare account."
  tags: ["logs", "logpush", "observability", "security"]
...
Cloudflare's official Logpush MCP server. Inspect Logpush job data with your Cloudflare account.

## How authentication works

1. Click **Connect account** on the Cloudflare Logpush card.
2. A Cloudflare Logpush sign-in window opens. Approve access for the workspace.
...
- Tools are served by the vendor and discovered at session start (Logpush jobs and log data).
