...
metadata:
  ...
  version: "1.0.0"
  description: "incident.io's official hosted MCP server. Connect with your incident.io account to manage incidents and on-call."
  tags: ["incidents", "on-call", "monitoring", "reliability"]
...
incident.io's official hosted MCP server. Connect with your incident.io account to manage incidents and on-call.

## How authentication works

1. Click **Connect account** on the incident.io card.
2. A incident.io sign-in window opens. Approve access for the workspace.
...
- Tools are served by the vendor and discovered at session start (incidents, alerts, and schedules).
