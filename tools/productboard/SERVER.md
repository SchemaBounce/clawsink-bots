...
metadata:
  ...
  version: "1.0.0"
  description: "Productboard's official hosted MCP server. Connect with your Productboard account to work with features and feedback."
  tags: ["product-management", "roadmap", "feedback", "features"]
...
Productboard's official hosted MCP server. Connect with your Productboard account to work with features and feedback.

## How authentication works

1. Click **Connect account** on the Productboard card.
2. A Productboard sign-in window opens. Approve access for the workspace.
...
- Tools are served by the vendor and discovered at session start (features, notes, and roadmaps).
