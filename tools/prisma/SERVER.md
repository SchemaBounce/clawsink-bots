...
metadata:
  ...
  displayName: "Prisma"
  version: "1.0.0"
  description: "Prisma's official hosted MCP server. Connect with your Prisma account to manage Postgres databases and schema."
  tags: ["database", "orm", "postgres", "schema"]
...
Prisma's official hosted MCP server. Connect with your Prisma account to manage Postgres databases and schema.

## How authentication works

1. Click **Connect account** on the Prisma card.
2. A Prisma sign-in window opens. Approve access for the workspace.
...
- Tools are served by the vendor and discovered at session start (projects, databases, and schema).
