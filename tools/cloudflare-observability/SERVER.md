...
metadata:
  ...
  version: "1.0.0"
  description: "Cloudflare's official Observability MCP server. Query Workers logs, analytics, and errors with your Cloudflare account."
  tags: ["observability", "logs", "workers", "monitoring"]
...
Cloudflare's official Observability MCP server. Query Workers logs, analytics, and errors with your Cloudflare account.

## How authentication works

1. Click **Connect account** on the Cloudflare Observability card.
2. A Cloudflare Observability sign-in window opens. Approve access for the workspace.
...
- Tools are served by the vendor and discovered at session start (Workers logs, analytics, and errors).
