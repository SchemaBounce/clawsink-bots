...
metadata:
  ...
  displayName: "fal"
  version: "1.0.0"
  description: "fal's official hosted MCP server. Connect with your fal account to run generative AI models."
  tags: ["ai", "inference", "image-generation", "video-generation"]
  category: "ai"
  author: "fal"
  license: "Proprietary"
...
fal's official hosted MCP server. Connect with your fal account to run generative AI models.

## How authentication works

1. Click **Connect account** on the fal card.
2. A fal sign-in window opens. Approve access for the workspace.
...
- Tools are served by the vendor and discovered at session start (models, runs, and outputs).
