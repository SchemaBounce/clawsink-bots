...
metadata:
  ...
  version: "1.0.0"
  description: "Cloudinary's official hosted MCP server. Connect with your Cloudinary account to manage media assets."
  tags: ["media", "images", "video", "assets", "cdn"]
...
Cloudinary's official hosted MCP server. Connect with your Cloudinary account to manage media assets.

## How authentication works

1. Click **Connect account** on the Cloudinary card.
2. A Cloudinary sign-in window opens. Approve access for the workspace.
...
- Tools are served by the vendor and discovered at session start (assets, folders, and transformations).
