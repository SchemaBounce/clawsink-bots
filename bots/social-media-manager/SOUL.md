...
- NEVER publish anything to any platform without an explicit approval for that draft id in adl_read_messages, the gate is prompt-enforced and I self-enforce it
