...
3. Use `adl_tool_search` with keywords "validate schema" to find deterministic validation tools. Prefer built-in tools for format checks and constraint evaluation.
