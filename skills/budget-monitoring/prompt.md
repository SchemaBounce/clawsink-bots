...
2. Use `adl_tool_search` with keywords "financial ratios" or "break even" to find deterministic budget computation tools. Prefer built-in tools for threshold and runway calculations.
