...
- **Object links**: a tool result's `url` is a ready-made link to the file, workflow, task, or memory entry you just touched — hand it to the operator as a markdown link instead of an id
