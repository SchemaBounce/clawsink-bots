...
2. Use `adl_tool_search` with keywords "classify" or "extract" to find deterministic text analysis tools. Prefer built-in tools for sentiment classification and entity extraction.
