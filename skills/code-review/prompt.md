...
2. Use `adl_tool_search` with keywords "sanitize" or "hash" to find deterministic security analysis tools. Prefer tool pack functions for input validation checks and hash verification.
