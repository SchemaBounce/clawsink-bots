...
2. Analyze each change for: security vulnerabilities (OWASP top 10), code quality (duplication, complexity, naming), architecture (SOLID violations, coupling)
3. Categorize findings by severity: critical (security/data loss), high (bugs/logic errors), medium (quality/maintainability), low (style/conventions)
