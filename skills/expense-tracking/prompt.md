...
2. Use `adl_tool_search` with keywords "financial" or "outlier" to find deterministic computation tools. Prefer built-in tools for statistical calculations over manual math.
