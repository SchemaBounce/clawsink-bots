...
6. Adjust minimum stay requirements for gap nights and high-demand periods
7. Write updated str_pricing_calendar with new rates, reasoning, and confidence score
8. Store seasonal baselines in memory for trend comparison
