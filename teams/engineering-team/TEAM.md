...
metadata:
  ...
  tags: ["engineering", "devops", "ci-cd", "code-quality", "sre", "reliability"]
  author: "schemabounce"
  license: "MIT"
...
dataKits:
  - ref: "data-kits/engineering@1.0.0"
    required: true
    installSampleData: false
northStar:
  industry: "Software Engineering"
  context: "Engineering team automating CI/CD, code quality, reliability, and release processes across a software product organization"
  requiredKeys:
    - tech_stack
    - deployment_targets
    - release_cadence
...
orgChart:
  ...
  domains:
    ...
    - name: "Quality"
      ...
      children:
        - name: "API Testing"
          description: "Contract tests and regression fixtures"
          head: api-tester
        - name: "Tech Debt"
          description: "Refactor tracking and paydown planning"
          head: tech-debt-tracker
    - name: "Project Management"
      description: "Release cadence, scope, and sequencing"
      head: release-manager
    - name: "DevOps"
      description: "Pipelines, infrastructure, and deployment automation"
      head: sre-devops
      children:
        - name: "Automation"
        ...
        - name: "Reliability"
          description: "SLA monitoring, uptime tracking, and alerting"
          head: uptime-manager
  roles:
  ...
  escalation:
    ...
    paths:
      ...
      - name: "SLA Breach"
        trigger: "sla_breach"
        chain: [uptime-manager, sre-devops, software-architect]
...
| Documentation Writer | Automated doc updates and gap detection | Event-triggered |
| Uptime Manager | SLA tracking, availability alerting | @every 15m |
...
- Uptime Manager detects SLA risk -> alert to SRE & DevOps
- Tech Debt Tracker identifies regression -> alert to Software Architect
- Documentation Writer finds doc gap -> alert to Software Architect
